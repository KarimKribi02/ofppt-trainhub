...
const GestionParticipant = () => {
  // État pour la gestion des données des participants
  ...
  const fetchParticipants = async () => {
    ...
    try {
      ...
      setError('Erreur lors du chargement des participants. Veuillez réessayer.');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Erreur lors de l\'ajout du participant. Veuillez réessayer.');
      console.error('Erreur d\'ajout du participant:', err);
    }
  };
        ...
        <div className="mb-8 md:flex md:items-center md:justify-between">
          ...
          >
            ...
            <p className="mt-1 text-sm text-orange-700">
              Créez et gérez tous vos participants en un seul endroit
            </p>
          </motion.div>
              ...
              <div className="shadow-lg rounded-lg overflow-hidden border border-orange-100">
                {loading ? (
                  ...
                  <div className="bg-white px-4 py-12 text-center">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Commencez par ajouter un nouveau participant.</p>
                    <motion.button
                      type="button"
                      ...
                      whileTap={{ scale: 0.95 }}
                    >
                      <svg xmlns="http://2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                      </svg>
                      ...
                      <tbody className="bg-white divide-y divide-orange-100">
                        {participants.data.map((participant, index) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-500 truncate max-w-xs">{participant.email}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                          <p className="text-sm text-orange-700">
                            Affichage de <span className="font-medium">1</span> à <span className="font-medium">{participants.data.length}</span> sur <span className="font-medium">{participants.data.length}</span> résultats
                          </p>
                        </div>
                        <div>
